...
ActiveRecord::Schema.define(version: 2021_10_17_051740) do
  ...
  create_table "import_summaries", force: :cascade do |t|
    t.bigint "imported_file_id"
    t.string "stats"
    t.string "messages"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["imported_file_id"], name: "index_import_summaries_on_imported_file_id"
  end
  ...
  add_foreign_key "import_summaries", "imported_files"
